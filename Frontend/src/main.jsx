...
const router = createBrowserRouter([
  {
    ...
    children: [
      ...
      { path: '/RocketGame/single/:subjectGame/:grade/:level', element: <RocketGame mode="single" /> },
      { path: '/RocketGame/multi/:subjectGame/:grade/:level', element: <RocketGame mode="multi" /> },
